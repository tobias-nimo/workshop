...
7Note that a similar analysis can be carried out with $B$ and the left-singular unitary matrices – we stick with $A$ for our experiments.
...
- A. Agbajanyan, L. Zettlemoyer, and S. Gupta (2020) Intrinsic Dimensionality Explains the Effectiveness of Language Model Fine-Tuning. arXiv:2012.13255 [cs], December 2020. URL http://arxiv.org/abs/2012.13255.
...
- B. Brown, B. Mann, N. Ryder, M. Subbiah, J. Kaplan, P. D. A. and M. Ziegler (2017) A single, a single, and a single, Deep Learning. In ICML, 2017. Full version available at http://arxiv.org/abs/1705.03962.
- C. E. C. and J. Candès (2010) A single, a single, and a single, Deep Learning. Language Models are Few-Shot Learners. arXiv:2005.14165 [cs], July 2020. URL http://arxiv.org/abs/2005.14165.
- J. C. F. and J. Candès (2014) A single, a single, and a single, Deep Learning. Language Models are Few-Shot Learners. arXiv:2005.14165 [cs], July 2020. URL http://arxiv.org/abs/2005.14165.
- C. E. C. and B. Donil (2019) A single, a single, and a single, Deep Learning. Language Models are Few-Shot Learners. arXiv:2005.14165 [cs], July 2020. URL http://arxiv.org/abs/2005.14165.
- B. Donil, B. Shakibi, L. D. DeVlin, M. Chai, and R. Z. Devlin (2014) A single, a single, and a single, Deep Learning. A unified architecture for natural language processing: deep neural networks with multitask learning. In Proceedings of the 25th international conference on Machine learning, ICML ’08, pp. 160–167, New York, NY, USA, July 2008. Association for Computing Machinery. ISBN 978-1-60558-205-4. doi: 10.1145/1390156.1390177. URL https://doi.org/10.1145/1390156.1390177.
- B. Donil, B. Shakibi, L. D. DeVlin, M. Chai, R. Z. Devlin, and N. de Freitas (2014) Predicting parameters in deep learning, 2014.
- D. Devlin, M. Weichang, K. Lee, and K. Toutanova (2019a) Best: Pre-training of deep bidirectional transformers for language understanding, 2019a.
- D. Devlin, M. Weichang, K. Lee, and K. Toutanova (2019b) Best: Pre-training of Deep Bidirectional Transformers for Language Understanding. arXiv:1810.04805 [cs], May 2019b. URL http://arxiv.org/abs/1810.04805. arXiv: 1810.04805.
- B. Dolan and B. Horowitz (2017) William B. Dolan and Chris Brockett. Automatically constructing a corpus of sentential paraphrases. In Proceedings of the Third International Workshop on Paraphrasing (IWP2005), 2005. URL https://aclanthology.org/I05-5002.
- G. Gardner, A. Shimorina, S. N. Narayan, and L. Perez-Beltrachini (2017) The webnlg challenge: Generating text from rdf data. In Proceedings of the 10th International Conference on Natural Language Generation, pp. 124–133, 2017.
- G.
...
- Ghorbani et al. (2019) Lars Grasedyck, Daniel Kressner, and Christine Tobler. A literature survey of low-rank tensor approximation techniques. *GAMM-Mitteilungen*, 36(1):53–78, 2013.
- Haim and Lee (2021) Jihun Ham and Daniel D. Lee. Grassmann discriminant analysis: a unifying view on subspace-based learning. In *ICML*, pp. 376–383, 2008. URL https://doi.org/10.1145/1390156.1390204.
- Haim and Lee (2021) Karen Hambardzumyan, Hrant Khachatrian, and Jonathan May. WARP: Word-level Adversarial ReProgramming. *arXiv:2101.00121 [cs]*, December 2020. URL http://arxiv.org/abs/2101.00121. arXiv: 2101.00121.
...
- Haim and Lee (2021) Neil Houlsby, Andrei Giurgiu, Stanislaw Jastrzebski, Bruna Morrone, Quentin de Laroussilhe, Andrea Gesmundo, Mona Attariyan, and Sylvain Gelly. Parameter-Efficient Transfer Learning for NLP. *arXiv:1902.00751 [cs, stat]*, June 2019. URL http://arxiv.org/abs/1902.00751.
...
- Khodak et al. (2019) Mikhail Khodak, Neil Tenenholtz, Lester Mackey, and Nicolò Fusi. Initialization and regularization of factorized neural layers, 2021.
- Klingma and Be (2021) Diederik P. Kingma and Jimmy Ba. Adam: A method for stochastic optimization, 2017.
...
- Li and Liang (2021) Xiang Lisa Li and Percy Liang. Prefix-Tuning: Optimizing Continuous Prompts for Generation. *arXiv:2101.00190 [cs]*, January 2021. URL http://arxiv.org/abs/2101.00190.
- Li and Lin (2016) Yuanzhi Li and Yingyu Liang. Learning overparameterized neural networks via stochastic gradient descent on structured data. In *Advances in Neural Information Processing Systems*, 2018.
...
- Lyashchilov and Frank Hutter. Decoupled weight decay regularization. arXiv preprint arXiv:1711.05101, 2017.
- Lyashchilov and Frank Hutter. Decoupled weight decay regularization, 2019.
- Karimi Mahabadi, James Henderson, and Sebastian Ruder. Compacter: Efficient low-rank hypercomplex adapter layers, 2021.
- Nandragomir Radev, Rui Zhang, Amrit Rau, Abhinand Sivaprasad, Chiachun Hsieh, Xiangru Tang, Aadit Vyas, Neha Verma, Pranav Krishna, et al. Dart: Open-domain structured data record to text generation. arXiv preprint arXiv:2007.02871, 2020.
...
- Ruch, H. and Reddy, H. (1955). Learning multiple visual domains with residual adapters. arXiv:1705.08045 [cs, stat], November 2017. URL http://arxiv.org/abs/1705.08045. arXiv: 1705.08045.
- Ruch, Gregor Geigle, Max Glockner, Tilman Beck, Jonas Pfeiffer, Nils Reimers, and Iryna Gurevych. Adapterdrop: On the efficiency of adapters in transformers, 2020.
...
In this paper we use the measure  $\phi(A, B, i, j) = \psi(U_A^i, U_B^j) = \frac{\|U_A^{-1}U_B\|_F^2}{\min\{i, j\}}$  to measure the subspace similarity between two column orthonormal matrices  $U_A^i \in \mathbb{R}^{d \times i}$  and  $U_B^j \in \mathbb{R}^{d \times j}$ , obtained by taking columns of the left singular matrices of  $A$  and  $B$ . We point out that this similarity is simply a reverse of the standard Projection Metric that measures distance between subspaces Ham &amp; Lee (2008).
